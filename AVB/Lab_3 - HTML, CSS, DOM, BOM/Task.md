...
6. Добавьте на страницу шапку, внутри которой расположите логотип любой организации, имеющей сайт (на ваш выбор) и навигацию состоящую из двух ссылок: "Промо" (якорь на тег main ниже шапки) и "Сайт" (ссылка на реальный сайт организации, чей логотип вы использовали)
...
10. Заполните все блоки с классом item информацией из любых реальных товаров, любого реального интернет-магазина или возьмите из примера ниже. Каждый блок item должен содержать изображение товара, цену и название. Можете дополнить другой информацией на ваше усмотрение.
...
1. Реализуйте через JavaScript якорный переход по нажатию на ссылку "Промо". В результате клика экран должен проскроллиться к началу блока promo-catalog.
2. Используя Javascript выделете все чётные блоки `.item` в блоке promo-catalog цветом фона на ваше усмотрение.
